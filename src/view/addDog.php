<div class="container">
    <h2 class="text-orange">Ajouter un chien</h2>
    <form action="index.php?action=addDog" method="POST">
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control col-md-2" id="taille" name="taille">
            </div>
            
            <div class="form-group col-md-6">
                <label for="poids">Poids</label>
                <input type="number" class="form-control col-md-2" id="poids" name="poids">
            </div>
        </div>
