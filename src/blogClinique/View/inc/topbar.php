<header>
	<nav class="bgBlue navSize">
		<!-- <div class="container"> -->
			<div class="nav-wrapper" >

				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo"><img src="<?=ROOT_URL?>/static/img/logoClinique.png" alt="logo clinique" class="logo"></a>

				<a href="#" data-activates="mobile-menu" class="button-collapse"><i class="material-icons">menu</i></a>

				<ul class="right hide-on-med-and-down containerMenu">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="../index.php">Clinique</a></li>
