...
<main>
  <div class="container">
    ...
    <?php else: ?>
    <h1 class="page-title">LE BLOG – INFOS MEDICALES VETERINAIRES</h1>
    <div class="row">
        ...
        <div class="col l6 m6 s12">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              <p><a href="<?=ROOT_URL?>blog_post_<?=$oPost->id?>.html" class="textOrange">Voir le chapitre au complet</a></p>
            </div>
