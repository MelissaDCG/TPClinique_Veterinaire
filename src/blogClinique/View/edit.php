...
<div class="container">
  <?php if (empty($this->oPosts)): ?>
    ...
    <p><button type="button" onclick="window.location='<?=ROOT_URL?>admin_add.html'" class="btn waves-effect waves-light bgOrange">Ajoutez votre premier article!</button></p>
  <?php else: ?>
  <h1>Edition</h1>
